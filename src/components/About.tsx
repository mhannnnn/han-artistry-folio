...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 px-6 md:px-12 lg:px-24 bg-card">
      <div ref={aboutRef} className="max-w-4xl mx-auto opacity-0">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary/20 via-accent/20 to-secondary/40 relative overflow-hidden">
